...
<div>
    <h1>完整demo</h1>
    <div align="center" ><label>标题</label><input name="title" /></div>
    <div align="center" ><label>描述</label><input name="desc" /></div>
    <div align="center" ><label>封面图片</label><input name="imgurl" /></div>
   <div align="center" style="padding-bottom: 50px "> <script id="editor" type="text/plain" style="width:512px;height:250px;"></script></div>
<div align="center" ><button  onclick="sub()">这里提交页面内容</button></div>
